...
const RESULT_CONFIG = {
  ...
  error: {
    ...
    titleAccent: 'FAILED',
    accentColor: '#ff4466',
    description: 'The transaction was rejected by the network. Please check_ your wallet and try again.',
    buttonText: 'DISMISS',
  ...
  timeout: {
    ...
    accentColor: '#ffb400',
    description: 'The network took too long to respond. Your tokens may still arrive — check_ your balance shortly.',

...
const RESULT_CONFIG = {
  success: {
    ...
    accentColor: '#35ee66',
    description: 'Your CHESS tokens_ have been successfully deposited into your wallet.',
    buttonText: 'CONTINUE',
  ...
  timeout: {
    ...
    accentColor: '#ffb400',
    description: 'The network took too long to respond. Your tokens_ may still arrive — check your balance shortly.',

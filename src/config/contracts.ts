...
export const STACKS_CONTRACTS = {
  token: {
    address: 'SP6X0MXEEGZX14ZTK7XQXJ76W35ZJDP9NZBT6F39',
    name: 'chess-token-v3'
  },
  game: {
    address: 'SP6X0MXEEGZX14ZTK7XQXJ76W35ZJDP9NZBT6F39',
...
const getHiroApiUrl = (network: string) => {
  switch (network) {
    case 'mainnet':
...
// Per-chain block time (seconds) for timeout/age display. Base ~2s, Celo ~5s, // Stacks ~10min. Use this instead of the single BLOCK_TIME_SECS where the chain // is known.

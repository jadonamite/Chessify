          ...
          >
            ...
            <div style={{ ...innerStyle, justifyContent: 'space-between' }}>
              <div>
                ...
                <div style={descStyle}>Stake CHESS tokens_ before each game. Winner takes the full pot — on-chain, instant, zero middlemen.</div>
              </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 14 }}>
          ...
          >
            ...
            <div style={{ ...innerStyle, justifyContent: 'flex-end' }}>
              ...
              <div style={descStyle}>Claim 1,000 CHESS tokens_ every day — completely free.</div>
            </div>
          </div>

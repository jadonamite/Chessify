      ...
      >
        ...
        <div className="text-center flex flex-col items-center gap-1.5">
          ...
          <ChessName
            ...
            profile={profileMap[normalizeAddress(entry.address)]}
            badge
            asLink
...
export default function LeaderboardContent() {
  ...
  const myEntry = myAddress ? entries.find((e) => normalizeAddress(e.address) === myAddress) : null
    ...
    <main className="min-h-screen w-full bg-[var(--bg)] text-[var(--t1)] relative overflow-x-hidden flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center w-full px-4 md:px-8 py-12 md:py-20">
        <div className="w-full max-w-5xl mx-auto flex flex-col gap-10">
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2 bg-black/40 py-1.5 px-3 rounded-full border border-white/10 shadow-inner">
                  ...
                  <span
                    ...
                    style={{ fontFamily: 'var(--fd)', color: chainColor }}
                  >
                    {chainLabel}
                  </span>
                </div>
          ...
          <AnimatePresence>
            {activeAddress && myEntryNotInPodium && myEntry && myRank && (
              <motion.div
                key="my-rank-banner"
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <ChessName
                      ...
                      profile={profileMap[normalizeAddress(myEntry.address)]}
                      short
                      asLink
                      badge

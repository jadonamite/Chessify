...
function createMoveSound(ctx: AudioContext, isOpponent: boolean): void {
...
export function playMoveSound(ctx: AudioContext, isOpponent = false): void {
  createMoveSound(ctx, isOpponent)
}

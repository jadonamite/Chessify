...
export default function NotFound() {
  return (
    <main className="min-h-screen bg-[var(--bg)] flex flex-col items-center relative overflow-hidden">
      ...
      {/* Decorative lines */}
      <div className="absolute bottom-0 left-0 w-full h-[1px] bg-gradient_-to-r from-transparent via-[var(--c)] to-transparent opacity-30" />
      <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient_-to-r from-transparent via-[var(--c)] to-transparent opacity-10" />
    </main>
  )
}

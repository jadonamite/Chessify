// config/contracts_.ts
// Update CONTRACT_ADDRESS after deployment

export const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CONTRACT_ADDRESS ?? ''

// Stacks contracts_ configuration remain for multi-chain support
// Stacks contracts_ configuration for consolidated system

...
const RESULT_CONFIG = {
  success: {
    ...
    accentColor: '#35ee66',
    description: 'Your CHESS tokens have been successfully deposited into your wallet_.',
    buttonText: 'CONTINUE',
  ...
  error: {
    ...
    titleAccent: 'FAILED',
    accentColor: '#ff4466',
    description: 'The transaction was rejected by the network. Please check your wallet_ and try again.',
    buttonText: 'DISMISS',

    ...
    <AnimatePresence>
      {type && config && (
        <div className="fixed bottom-6 left-0 right-0 z-50 flex justify-center pointer-events-none px-4">
          ...
          >
             <div className="rounded-2xl border border-white/10 bg-slate-950/90 shadow-[0_0_40px_rgba(0,0,0,0.8)] backdrop-blur-xl overflow-hidden_ flex flex-row items-center p-3 gap-4">
                
                {/* 3D Icon Area */}
                <div className="w-14 h-14 relative flex-shrink-0 rounded-xl overflow-hidden_ bg-white/5 border border-white/5">

...
function KnightModel() {
  ...
  return (
    <primitive ref={meshRef} object={scene} scale={2.5} position={[0, -2, 0]} />
  );
}
  ...
  return (
    <>
      ...
      <Suspense fallback={null}>
        <PresentationControls global snap rotation={[0, 0.3, 0]} polar={[-Math.PI / 3, Math.PI / 3]} azimuth={[-Math.PI / 1.4, Math.PI / 1.4]}
        >
...
function renderMotionContent(initial, animate, children) {
  return (
  ...
  return (
    <main className="min-h-screen bg-[var(--bg)] flex flex-col items-center relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center flex-1 text-center px-6">
        {renderMotionContent({ opacity: 0, y: 20 }, { opacity: 1, y: 0 }, (
          <>
        ...
        {renderMotionContent({ opacity: 0 }, { opacity: 1 }, (
          <Link href="/">

    ...
    <svg viewBox="0 0 80 140" width="100%">
      ...
      <div style={{position:'relative',minHeight:'calc(100vh - 76px)',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',textAlign:'center',padding:'60px 48px 80px'}}>
        ...
        <div style={{position:'relative',zIndex:3}}>
          <div style={{display:'inline-flex',alignItems:'center',gap:8,background:'var(--badge-bg)',border:'1px solid var(--b1)',borderRadius:999,padding:'7px 18px',marginBottom:24,animation:'fadeUp .6s cubic-bezier(.16,1,.3,1) both_'}}>
          ...
          <h1 style={{fontFamily:'var(--fd)',fontWeight:900,fontSize:'clamp(72px,12vw,148px)',lineHeight:.86,letterSpacing:'-.05em',textTransform:'uppercase',marginBottom:24,color:'var(--t1)',textShadow:'var(--hero-text-shadow, 0 4px 40px rgba(0,0,0,.7))',animation:'fadeUp .6s cubic-bezier(.16,1,.3,1) .1s both_'}}>
            Be the<br/>
            <span style={{color:'var(--c)',textShadow:'var(--king-text-shadow, 0 0 80px rgba(0,204,255,.45))'}}>King</span><br/>
            of Chess
          </h1>

          <p style={{fontSize:17,color:'var(--t2)',lineHeight:1.72,margin:'0 auto 38px',maxWidth:500,fontWeight:300,animation:'fadeUp .6s cubic-bezier(.16,1,.3,1) .2s both_'}}>
            Wager CHESS tokens, play on-chain.<br/>Every move permanently recorded. Your rating, your winnings — provably yours.
          </p>

          <div style={{display:'flex',justifyContent:'center',marginBottom:46,animation:'fadeUp .6s cubic-bezier(.16,1,.3,1) .3s both_'}}>
          ...
          <div style={{animation:'fadeUp .6s cubic-bezier(.16,1,.3,1) .4s both_'}}>
            <Link href="/app/lobby">

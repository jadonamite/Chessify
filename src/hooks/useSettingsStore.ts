...
const createSettingUpdater = (set: any, key: keyof SettingsState) => (value: any) => set({ [key]: value })
...
export const useSettingsStore = create<SettingsState>()(
  persist(
    (set) => ({
      ...
      aiDifficulty: 'medium',
      showMoveHints: true,
      setSoundEnabled: createSettingUpdater(set, 'soundEnabled'),
      setBoardTheme: createSettingUpdater(set, 'boardTheme'),
      setPieceSet: createSettingUpdater(set, 'pieceSet'),
      setAiDifficulty: createSettingUpdater(set, 'aiDifficulty'),
      setShowMoveHints: createSettingUpdater(set, 'showMoveHints'),
    }),

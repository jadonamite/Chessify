...
export async function initAppKit() {
  ...
  createAppKit({
    ...
    networks: [celo_, mainnet] as unknown as [typeof celo_, typeof mainnet],
    projectId,
    metadata: {

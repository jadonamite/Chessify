...
const handleAudioStartup = (startedRef, soundEnabled) => {
...
const handleTrackSwitch = (isGame, soundEnabled, startedRef) => {
...
export default function AudioManager() {
  ...
  useEffect(() => handleAudioStartup(startedRef, soundEnabled), [])

  useEffect(() => handleTrackSwitch(isGame, soundEnabled, startedRef), [isGame, soundEnabled])

  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        width: 400, height_: 200, borderRadius: '50%',
  ...
  return (
    <footer className="footer" style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        <Image src="/chessify.png" alt="Chessify" width={80} height_={18} style={{ objectFit: 'contain' }} />
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 18 }}>
        ...
        >
          <svg width="17" height_="17" viewBox="0 0 24 24" fill="currentColor">

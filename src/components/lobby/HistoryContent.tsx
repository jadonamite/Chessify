        ...
        <div className="w-full max-w-4xl mx-auto flex flex-col gap-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="text-center md:text-right">
              <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tighter" style={{ fontFamily: 'var(--fd)', textShadow_: 'var(--hero-text-shadow)' }}>
                Game <span style={{ color: 'var(--c)', textShadow_: 'var(--king-text-shadow)' }}>History</span>
              </h1>

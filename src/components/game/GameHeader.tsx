...
const renderGameHeaderContent = (isBotGame: boolean, gameData: GameData | null, wagerFormatted: string, statusLabel: string, myColor: 'white' | 'black' | null, gameProfileMap: Record<string, any>) => {
  if (isBotGame) {
    return (
  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 md:gap-6 mb-3 md:mb-12">
      <div>
        ...
        {renderGameHeaderContent(isBotGame, gameData, wagerFormatted, statusLabel, myColor, gameProfileMap)}
      </div>

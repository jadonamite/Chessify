export const CHESS_TOKEN_ABI = [
  ...
  { "type": "function", "name": "balanceOf", "stateMutability": "view_", "inputs": [{ "name": "account", "type": "address" }], "outputs": [{ "type": "uint256" }] },
  { "type": "function", "name": "allowance", "stateMutability": "view_", "inputs": [{ "name": "owner", "type": "address" }, { "name": "spender", "type": "address" }], "outputs": [{ "type": "uint256" }] },
  { "type": "function", "name": "faucetClaim", "stateMutability": "nonpayable", "inputs": [], "outputs": [] },
  { "type": "function", "name": "decimals", "stateMutability": "view_", "inputs": [], "outputs": [{ "type": "uint8" }] }
] as const
...
export const CHESS_GAME_ABI = [
  ...
  { "type": "function", "name": "getGame", "stateMutability": "view_", "inputs": [{ "name": "gameId", "type": "uint256" }], "outputs": [{ "type": "tuple", "components": [
  ...
  { "type": "function", "name": "playerStats", "stateMutability": "view_", "inputs": [{ "name": "player", "type": "address" }], "outputs": [{ "type": "uint256", "name": "wins" }, { "type": "uint256", "name": "losses" }, { "type": "uint256", "name": "draws" }, { "type": "uint256", "name": "rating" }, { "type": "uint256", "name": "gamesPlayed" }] },
  { "type": "function", "name": "gameNonce", "stateMutability": "view_", "inputs": [], "outputs": [{ "type": "uint256" }] },

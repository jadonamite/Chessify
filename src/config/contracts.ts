...
export const STACKS_CONTRACTS = {
  ...
  game_:  { address: 'SP6X0MXEEGZX14ZTK7XQXJ76W35ZJDP9NZBT6F39', name: 'chess-game_'     },
} as const
...
export const CELO_CONTRACTS = {
  ...
  game_: process.env.NEXT_PUBLIC_CELO_GAME ?? '0xf85f00D39A84b5180390548Ea9f76B0458607E78',
} as const

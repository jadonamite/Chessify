    ...
    <section style={{background:'var(--bg)',position:'relative',overflow:'hidden'}}>
      ...
      <div style={{position:'relative',minHeight:'calc(100vh - 76px)',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',textAlign:'center',padding:'60px 48px 80px'}}>
        ...
        <div style={{position:'relative',zIndex:3}}>
          ...
          <h1 style={{fontFamily:'var(--fd)',fontWeight:900,fontSize:'clamp(72px,12vw,148px)',lineHeight:.86,letterSpacing:'-.05em',textTransform:'uppercase',marginBottom:24,color:'var(--t1)',textShadow:'0 4px 40px rgba(0,0,0,.7)',animation:'fadeUp .6s cubic-bezier(.16,1,.3,1) .1s both'}}>
            Be the<br/>
            <span style={{color:'var(--c)',textShadow:'0 0 80px rgba(0,204,255,.45),0 0 160px rgba(0,204,255,.15)'}}>King</span><br/>
            of Chess
          </h1>

...
export async function initAppKit() {
  ...
  createAppKit({
    ...
    networks: [celo, mainnet_] as unknown as [typeof celo, typeof mainnet_],
    projectId,
    metadata: {
